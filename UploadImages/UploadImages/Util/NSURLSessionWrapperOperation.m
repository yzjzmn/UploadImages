//
//  NSURLSessionWrapperOperation.m
//  博地商户端
//
...
@interface NSURLSessionWrapperOperation ()
{
...
@implementation NSURLSessionWrapperOperation

+ (instancetype)operationWithURLSessionTask:(NSURLSessionTask*)task {
    NSURLSessionWrapperOperation* operation = [NSURLSessionWrapperOperation new];
    operation.task = task;
    return operation;
}
